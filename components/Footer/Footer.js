...
function Footer() {
  return (
    <footer className="mdl-mini-footer">
      <Row type="flex" align="middle" justify="center" style={{width:"100%",textAlign:"center"}}>
        <Col xs={6} sm={1} md={1} lg={1}>
          <a href="https://github.com/Roxyhuang" role="button" title="GitHub">
          ...
          <Col xs={6} sm={3} md={3}lg={3}><a href="https://github.com/Roxyhuang">Neo_Huang</a></Col>
      </Row>
    </footer>
  );
}
